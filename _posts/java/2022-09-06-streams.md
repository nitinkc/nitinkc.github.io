...
- Each _intermediate operation_ is **lazily executed** and returns a **stream** as a result.
...
- **INTERMEDIATE OPERATIONS**: These transform a stream into another stream. **Streams use lazy evaluation**,
...
- **Terminal Operations** : These operations produce a result or a side-effect and **consume the stream**, 
