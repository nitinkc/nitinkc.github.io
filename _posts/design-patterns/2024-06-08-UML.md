...
![](https://upload.wikimedia.org/wikipedia/commons/2/21/UML_association%2C_aggregation_and_composition_examples_for_a_bicycle.png){:width="50%" height="50%" .align-right}
