...
client and provider without bothering about implementation semantics
...
- anyone can leave from the junior chefs and new one can come. Customers need not
  be worried
