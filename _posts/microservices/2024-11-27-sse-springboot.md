...
flowchart TB
    ...
    subgraph Alerts ["Alerts"]`n        A1[High Connection Count]
...
flowchart TB
    ...
    subgraph Infrastructure ["Infrastructure"]`n        I1[Load Balancer Config]
        I2[Firewall Rules]
...
flowchart LR
    ...
    subgraph Clustering ["Clustering"]`n        C1[Sticky Sessions]
        C2[Event Bus]
        C3[Shared State]
        C4[Message Broker]
    end
